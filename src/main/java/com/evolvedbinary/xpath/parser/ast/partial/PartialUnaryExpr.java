...
public class PartialUnaryExpr extends AbstractPartialASTNode<UnaryExpr, ValueExpr> {
    ...
    public PartialUnaryExpr(final String signs) {
        this.signs = signs;
    }

    @Override
    protected String describe() {
        return "UnaryExpr(" + signs + ", ?)";
    }

    @Override
    public UnaryExpr complete(final ValueExpr valueExpr) {
        return new UnaryExpr(signs, valueExpr);
    }
}
